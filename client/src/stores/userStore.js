...
const { setMessage } = appStore_1.appStore.getState();
exports.userStore = (0, zustand_1.default)((set) => ({
    user: "",
    token: "",
    setToken: (localToken) => {
    ...
    login: (email, password) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            let res = yield axios_1.default.post("/api/v1/user/login", JSON.stringify(body), config);
            console.log(res);
    ...
    register: (email, password) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            let res = yield axios_1.default.post("/api/v1/user/register", JSON.stringify(body), config);
            console.log(res);
            set(() => ({ token: res.data.token }));
