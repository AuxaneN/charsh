...
const Register = () => {
    ...
    const { register } = (0, userStore_1.userStore)((state) => state);
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { children: ["Register", (0, jsx_runtime_1.jsxs)("form", { children: [(0, jsx_runtime_1.jsx)("input", { placeholder: "email", type: "email", name: "email", onChange: (e) => {
